...
SEARCH_BOOK_URL = DATA_SOURCE_HOME + 'modules/article/search.php?searchtype={search_type}&searchkey={book_name}&page={page}'
# selector
...
SEARCH_BOOK_SELECTOR = '#content > table > tr > td > div'
SEARCH_BOOK_PAGE_NUMBER_SELECTOR = '#pagelink > a.last'
SEARCH_BOOK_ID_SELECTOR = 'div:nth-child(1) > a'
SEARCH_BOOK_TITLE_SELECTOR = 'div:nth-child(2) > b > a'
SEARCH_BOOK_COVER_URL_SELECTOR = 'div:nth-child(1) > a > img'
SEARCH_BOOK_WRITER_AND_TYPE_SELECTOR = 'div:nth-child(2) > p:nth-child(2)'
SEARCH_BOOK_TAGS_SELECTOR = 'div:nth-child(2) > p:nth-child(4) > span'
SEARCH_BOOK_INTRODUCTION_SELECTOR = 'div:nth-child(2) > p:nth-child(5)'
SEARCH_BOOK_TOO_FAST_SELECTOR = 'body > div > div > div > div.blockcontent > div:nth-child(1)'
# key word
...
SEARCH_BOOK_TOO_FAST_KEY_WORD = '错误原因：对不起，两次搜索的间隔时间不得少于 5 秒'
# regex
SEARCH_BOOK_ID_REGEX = r'(?!.*\/)([0-9]*)(?=\.htm)'
# other
REQUESTS_HEADERS = {
